...
-(void)textFiledChange:(UITextField* )tf
{
    ...
    if (_MVAcounTf.text.length&&_MVPwdTf.text.length>=6&&_MVVerCodeTf.text.length && _MVInvCodeTf.text.length) {
        ...
        _MVReginBtn.backgroundColor= [UIColor colorWithHexString:@"#ec4646"];
...
-(UIButton *)MVTreatyBtn
{
    if (_MVTreatyBtn == nil)
    {
        ...
        [_MVTreatyBtn setTitleColor:[UIColor colorWithHexString:@"#ffae02"] forState:UIControlStateNormal];
