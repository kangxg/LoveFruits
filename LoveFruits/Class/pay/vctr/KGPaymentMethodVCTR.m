...
//    NSString *billno = [self genBillNo];
    ...
    payReq.scheme = @"aliptzwhl";//URL Scheme,在Info.plist中配置; 支付宝必有参数
...
-(UIButton *)MVSubmitBtn
{
    if (_MVSubmitBtn == nil)
    {
        ...
        _MVSubmitBtn.backgroundColor = [UIColor colorWithHexString:@"#ec4646"];
...
-(UILabel *)MVSumtileLabel
{
    if (_MVSumtileLabel == nil)
    {
        ...
        [_MVSumtileLabel sizeToFit];
        _MVSumtileLabel.textColor = [UIColor colorWithHexString:@"#ec4646"];
    }
