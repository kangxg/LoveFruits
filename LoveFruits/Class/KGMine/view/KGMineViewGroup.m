...
-(UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section
{
    ...
    logoutBtn.backgroundColor = [UIColor colorWithHexString:@"#ec4646"];
    ...
    lab1.textColor      = [UIColor colorWithHexString:@"#ec4746"];
    ...
    lab2.textColor      = [UIColor colorWithHexString:@"#ec4746"];
