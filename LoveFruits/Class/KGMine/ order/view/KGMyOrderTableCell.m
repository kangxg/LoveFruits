...
-(void)createLabelView
{
    ...
    self.KVOrderTypeLabel.textColor = [UIColor colorWithHexString:@"#ec4646"];
}
...
-(UIButton *)MVEnterPayBtn
{
    if (_MVEnterPayBtn == nil)
    {
        ...
        _MVEnterPayBtn.backgroundColor = [UIColor colorWithHexString:@"#ec4646"];
...
-(UIButton *)MVEnterBtn
{
    if (_MVEnterBtn == nil)
    {
        ...
        _MVEnterBtn.backgroundColor = [UIColor colorWithHexString:@"#ec4646"];
