...
//        [self.MVSellCountLabel sizeToFit];
        ...
        [_MVImageView sd_setImageWithURL:[NSURL URLWithString:_KModel.img] placeholderImage:[UIImage imageNamed:@"today-test"]];
    }
...
-(UIButton *)MVBuyButton
{
    if (_MVBuyButton == nil)
    {
        ...
        [_MVBuyButton setTitleColor:[UIColor colorWithHexString:@"#ffae02"] forState:UIControlStateNormal];
      
        _MVBuyButton.layer.masksToBounds = YES;
        _MVBuyButton.layer.borderWidth   = 0.5f;
        _MVBuyButton.layer.borderColor   = [UIColor colorWithHexString:@"#ffae02"].CGColor;
