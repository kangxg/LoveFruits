...
-(void)updateView:(KGProductDetailsModel *)model
{
    if (model)
    {
        ...
        switch (type) {
            case 7:
            {
                _MVOnsaleTypeImageView.image = [UIImage imageNamed:@"sales"];
...
-(UILabel *)MVOnsaleTypeLabel
{
    if (_MVOnsaleTypeLabel == nil)
    {
        ...
        _MVOnsaleTypeLabel.textColor = [UIColor colorWithHexString:@"#ec4646"];
    }
...
-(UILabel *)MVNewTypeLabel
{
    if (_MVNewTypeLabel == nil)
    {
        ...
        _MVNewTypeLabel.textColor = [UIColor colorWithHexString:@"#ec4646"];
    }
...
-(UILabel *)MVHotTypeLabel
{
    if (_MVHotTypeLabel == nil)
    {
        ...
        _MVHotTypeLabel.textColor = [UIColor colorWithHexString:@"#ec4646"];
    }
