...
-(void)createMenuLineView
{
    if (_MVLineView == nil)
    {
        ...
        _MVLineView.backgroundColor= [UIColor colorWithHexString:@"#ec4746"];
...
{
      [_MVSelectedBtn setTitleColor:[UIColor colorWithHexString:@"#ec4646"] forState:UIControlStateNormal];
